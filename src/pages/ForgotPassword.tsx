    ...
    return (
      <div className="flex h-screen bg-black">
        ...
        <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-900 via-purple-900 to-indigo-900" />
          <div className="absolute inset-0 bg-gradient-to-tr from-fuchsia-600/20 via-transparent to-purple-600/20" />
          
          {/* Animated gradient orbs */}
          <div className="absolute top-1/4 right-1/3 w-80 h-80 bg-fuchsia-500/25 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-purple-500/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2.5s' }} />
          <div className="absolute top-1/2 left-1/2 w-48 h-48 bg-indigo-500/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '5s' }} />
          ...
          {/* Decorative elements */}
          <div className="absolute top-16 right-16 w-24 h-24 border border-fuchsia-400/20 rounded-full" />
          <div className="absolute bottom-20 left-16 w-32 h-32 border border-purple-400/20 rounded-full" />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 border border-indigo-400/30 rounded-full" />
        </div>
      </div>
    );
  }
