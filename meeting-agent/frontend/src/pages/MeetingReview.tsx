...
// Types import
import type { Meeting, TranscriptSegment, ActionItem } from '../types/meeting'
import SpeakerRenamer from '../components/SpeakerRenamer'
...
export default function MeetingReview() {
  ...
  const handleRetry = async () => {
    try {
      ...
      const res = await fetch(`${apiUrl}/api/v1/meetings/${id}/retry`, {
        method: 'POST'
      })
